...
class Task01 {
    ...
    // инициализация судов
    initShips() {
        this.shipStack = new Stack([...Array(12)].map(s => new Ship(Utils.getShipName(), Utils.getInt(300, 600) * 1e6, Utils.getInt(3, 5) * 10, 2000 + Utils.getInt(17, 20), new Coord(), Utils.getInt(100, 300), Utils.getPort())));
    }
    // инициализация чисел
    initNumbers() {
        this.numberStack = new Stack([...Array(12)].map(s => Utils.getInt(10, 100)));
    }
    // инициализация строк
    initStrings() {
        this.stringStack = new Stack(Utils.destinations.sort(() => Math.random()));
    }
    // вывод судов
    showShips() {
