...
export class Task02Component implements OnInit, OnDestroy {
    ...
    formByNameAndLessMaxPrice = new FormGroup({
        name: new FormControl(this.nameList[0], Validators.required),
        maxPrice: new FormControl(this.yearList[0], Validators.required)
    });

    // форма для названия и максимальной цены
    formByPriceRange = new FormGroup({
