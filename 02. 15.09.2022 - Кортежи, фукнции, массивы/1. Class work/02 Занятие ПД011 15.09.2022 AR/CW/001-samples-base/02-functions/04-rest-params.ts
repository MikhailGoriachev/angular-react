...
// rest параметр - это набор опциональных параметров. При вызове такого метода,
...
printValue("sample 1");
printValue("sample 2", "chapter 1", "chapter 2");
printValue("sample 3", "chapter 1", "chapter 2", "chapter abc");