...
// используется для того чтобы при определении функции явно указать на отсутствие
...
// но такой переменной можно присвоить
...
// при опции компилятора --strictNullChecks null и undefined могут быть использованы для
// инициализации типов void или null и undefined соответственно
