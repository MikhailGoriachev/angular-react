// интерфейс описывает сигнатуру функции, функция должна принимать
// одно строковое значение и возвращать boolean
...
console.log(myArray1("Привет"));
console.log(myArray2("Пока"));