...
class Derived extends Base {
    ...
    constructor() {
        ...
        // !! Обязательная операция при наследовании !!
        super();
...
// доступен только метод method2, так как он public. Остальные методы
// не доступны так как данный код находится за пределами класса
derived1.method2(); 
